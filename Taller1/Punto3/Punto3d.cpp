//Planetas Troyanos Implementacion 3 Planetas Marco de Referencia Rotatorio
//Perturbamos la posicion original del planeta Troyano, moviendo su posicion original 1/1000
#include<iostream>
#include<cmath>
#include<vector>
#include"../vector.h"
